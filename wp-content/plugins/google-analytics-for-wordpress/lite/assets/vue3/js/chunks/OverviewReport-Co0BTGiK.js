import { D as watch, z as onMounted, K as onUnmounted, o as openBlock, c as createElementBlock, a as createBaseVNode, b as createVNode, C as withModifiers, F as Fragment, f as renderList, j as normalizeClass, G as createBlock, v as createCommentVNode, t as toDisplayString, k as ref, B as createTextVNode, u as unref, p as computed, a3 as storeToRefs, n as normalizeStyle, S as _export_sfc, L as renderSlot, w as withDirectives, R as vModelSelect, l as getMiGlobal$1, a6 as createSlots, E as withCtx } from "./AppOverlays-5d5Sx5mz.js";
import { _ as __, s as sprintf } from "./default-i18n-KrIlCc2E.js";
import { A as ApexLineChart } from "./ApexLineChart-B1Ki6nie.js";
import { L as LoadingSpinnerInline } from "./LoadingSpinnerInline-D6gqDANX.js";
import { I as Icon } from "./Icon-CyTPFQ-E.js";
import { u as useOverviewReportStore, b as buildApiFilters, f as fetchOverviewData, g as getInjectedMetricNames, a as getTabMetricsForQuery, O as OverviewProFeatureModal, c as generateSampleCustomDimensionsData, d as fetchCustomDimensionsData, e as fetchCustomDimensionsDeferredData, h as filterTabbedData, C as CUSTOM_DIMENSIONS_DIMENSION_TAB, i as CUSTOM_DIMENSIONS_TAB_TO_QUERY_ID, j as fetchFunnelData, k as getResponseDimensionOrder, Q as QUERY_DIMENSIONS, l as generateSampleBundleData, m as fetchFormSubmissionsData, n as filterFormSubmissionsData, o as fetchEcommerceOverviewData, p as fetchMarketingCampaignsData, q as fetchPagesData, r as fetchTopPagesData, s as fetchDemographicsData, t as fetchDevicesData, M as MC_TAB_TO_QUERY_ID, v as MC_DIMENSION_TAB, P as PAGES_TAB_TO_QUERY_ID, w as PAGES_DIMENSION_TAB, D as DEMOGRAPHICS_TAB_TO_QUERY_ID, x as DEMOGRAPHICS_DIMENSION_TAB, y as DEVICES_TAB_TO_QUERY_ID, z as DEVICES_DIMENSION_TAB } from "../reports-BlsvkvNU.js";
import { u as useSiteNotesStore, _ as _sfc_main$a } from "./SiteNotes-DBM0jG2y.js";
import { n as getUpgradeUrl, j as getMiGlobal, i as isAddonActive, R as REPORTING_REAUTH_ERROR, k as isPro } from "./ajax-pmt98pQN.js";
import { i as isRateMetric, a as isAvgMetric, t as toPercentValue, u as useOverviewChartData, b as isDurationMetric } from "./useOverviewChartData-Ck6feSW8.js";
import { _ as _sfc_main$b, u as useSortableTable } from "./ReportTableModal-BmJo0zPG.js";
import { f as formatPct, a as formatCurr, b as formatNum, s as stripUrlDomain } from "./overviewTableFormatters-CiLYjEZJ.js";
import { s as shouldHideNotSetValue, n as notSetLabel } from "./reportValues-CaiayvHH.js";
import { _ as _sfc_main$c, h as hasFunnelUsers, b as buildFunnelEmptyState, n as normalizeFunnelApiResponse } from "./useFunnelData-BRMRT3Cx.js";
...
import { A as AuthModal, R as ReAuthModal } from "./ReAuthModal-BAFYHRau.js";
...
const _hoisted_23$2 = { class: "monsterinsights-site-notes-toggle" };
const _hoisted_24$1 = {
  key: 1,
...
const _sfc_main$5 = {
  ...
  props: {
    ...
    /** Addon slug required for this table (e.g. 'dimensions'). When set and addon is inactive, Load More shows addon modal. */
    requiredAddon: {
      type: String,
      default: ""
    },
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        ...
        createBaseVNode("div", _hoisted_10$1, [
          ...
          _ctx.$slots["table-footer"] && !__props.loading && displayedRowsWithBar.value.length ? (openBlock(), createElementBlock("div", _hoisted_23$1, [
...
const OverviewReportTable = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-42fd4711"]]);
...
const _hoisted_22 = { class: "monsterinsights-overview-ecommerce-funnel__empty-message" };
const _hoisted_23 = {
  key: 4,
  class: "monsterinsights-overview-ecommerce-funnel__empty"
};
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const funnelHasUsers = computed(() => hasFunnelUsers(funnelDataRef.value?.steps));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        activeFunnel.value && funnelLoading.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
        ...
        ])) : activeFunnel.value && funnelTableRows.value.length > 0 && funnelHasUsers.value ? (openBlock(), createElementBlock("div", _hoisted_13, [
          ...
          createBaseVNode("p", null, toDisplayString(emptyState.value.title), 1),
          createBaseVNode("p", _hoisted_22, toDisplayString(emptyState.value.message), 1)
...
const OverviewReport = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-20a747fc"]]);
export {
