import { o as openBlock, c as createElementBlock, a as createBaseVNode, u as unref, w as withDirectives, x as vModelText, t as toDisplayString, C as withModifiers, v as createCommentVNode, k as ref, S as _export_sfc, L as renderSlot, G as createBlock, E as withCtx, j as normalizeClass, H as withKeys, B as createTextVNode, b as createVNode, p as computed } from "./AppOverlays-5d5Sx5mz.js";
import { n as getUpgradeUrl, o as getUrl, j as getMiGlobal, q as sanitizeHtml } from "./ajax-pmt98pQN.js";
import { a as useToast, d as useDialog } from "./addons-DT40ECM4.js";
import { l as licenseApi } from "./license-CZe4-J_K.js";
import { a as authApi } from "./auth-BTdxFMcG.js";
import { S as SlideDownUp } from "./SettingsBlock-kZ8sUmJ6.js";
...
const _hoisted_26 = { class: "monsterinsights-auth-actions" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const has_credentials = computed(() => {
      const flag = is_network ? auth.value.network_has_credentials : auth.value.has_credentials;
      return flag === void 0 ? true : !!flag;
    });
    const force_deauth = ref(!has_credentials.value);
    const showButtons = ref(!has_credentials.value);
    ...
    const text_missing_credentials = __("This connection is missing its Google credentials, so reports will not load. Reconnect MonsterInsights, or use Force Deauthenticate to reset the connection and start over.", "google-analytics-for-wordpress");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        is_authed.value ? (openBlock(), createElementBlock("div", _hoisted_19, [
          ...
          !has_credentials.value ? (openBlock(), createElementBlock("label", _hoisted_23, [
            _cache[4] || (_cache[4] = createBaseVNode("i", { class: "monstericon-warning-triangle" }, null, -1)),
            createBaseVNode("span", {
              textContent: toDisplayString(unref(text_missing_credentials))
            }, null, 8, _hoisted_24)
          ])) : createCommentVNode("", true),
          createVNode(SlideDownUp, null, {
            default: withCtx(() => [
              showButtons.value ? (openBlock(), createElementBlock("div", _hoisted_25, [
