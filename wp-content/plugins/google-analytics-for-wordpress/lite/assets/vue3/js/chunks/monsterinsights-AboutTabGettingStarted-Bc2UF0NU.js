...
import { n as getUpgradeUrl, o as getUrl, p as isNetworkAdmin } from "./ajax-pmt98pQN.js";
import { A as AboutBlock } from "./AboutBlock-CBqphb2y.js";
import { _ as _sfc_main$1 } from "./LaunchWizardButton-DnvghPUX.js";
import { o as openBlock, c as createElementBlock, b as createVNode, E as withCtx, a as createBaseVNode, t as toDisplayString, u as unref, G as createBlock, F as Fragment, f as renderList, v as createCommentVNode, j as normalizeClass, p as computed } from "./AppOverlays-5d5Sx5mz.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text_onboarding_note = sprintf(
      __(
        "Note: You will be transferred to %1$s.com to complete the setup wizard.",
        "google-analytics-for-wordpress"
      ),
      productName
    );
