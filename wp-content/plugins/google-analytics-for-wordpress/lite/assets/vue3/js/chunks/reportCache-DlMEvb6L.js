import { l as getMiGlobal } from "./AppOverlays-5d5Sx5mz.js";
import { J as useCachedFetch, K as getBackfillCache, L as fetchOverviewSection, N as backfillToWp, R as buildCacheKey, A as isSampleDataEnabled } from "../reports-BlsvkvNU.js";
      ...
      try {
        ...
        try {
          ...
          if (typeof console !== "undefined" && console.debug) {
            console.debug("[reportCache] Cache repopulation failed; serving the fetched data uncached:", backfillErr?.message || backfillErr, backfillErr);
          }
        }
        return raw;
      }
